    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b_show) {
            ...
            try {
                ...
                rs = stmt.executeQuery("SELECT master.bid, name, lev_type, lev_start_date, lev_end_date, lev_days, lev_remark FROM master JOIN leavemaster ON master.bid = leavemaster.bid WHERE leavemaster.bid = ? AND (lev_start_date <= ? AND lev_end_date >= ?) order by lev_type");
